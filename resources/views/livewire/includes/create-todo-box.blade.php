        ...
        <div id="create-form" class="hover:shadow p-6 bg-white border-blue-500 border-t-2">
            ...
            <div>
                ...
                <div>
                    ...
                    <div x-data="{ isOpen:  $wire.entangle('modalOpen')}">
                        <div
                            x-show="isOpen"
                            class=" flex fixed inset-0 z-40 min-h-full overflow-y-auto overflow-x-hidden transition items-center justify-center"
                            >
                            <div aria-hidden="true" class="fixed inset-0 w-full h-full bg-black/80 cursor-pointer" @click="isOpen = false">
                            </div>
                                ...
                                <div class="relative p-4 bg-gray-200 rounded-lg shadow dark:bg-gray-100 sm:p-5">
                                    ...
                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                        <div class="sm:col-span-2">
                                            <label for="name"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Todo Name</label>
                    ...
                    <div class="flex justify-center items-center">
                        <button wire:click="createModalOpen" 
